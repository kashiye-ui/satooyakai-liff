...
// ===== 画面: Q&Aボットのログ =====
const BOT_STATUS_LABELS = { answered: '回答済み', not_member: '未登録', soft_launch_blocked: '準備中(非公開)', error: 'エラー', undelivered: '未達(要フォロー)', handoff: '事務局対応' };
function botStatusBadge(status) {
  const kindMap = { answered: 'ok', not_member: 'hold', soft_launch_blocked: 'off', error: 'danger', undelivered: 'danger', handoff: 'hold' };
